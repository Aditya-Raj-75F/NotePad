...
android {
    ...
    (this as? Test)?.configure<ExtensionContainer> {
        ...
        extensions.getByType(JacocoTaskExtension::class).apply {
            ...
            excludes?.addAll(mutableListOf("jacocoDebug/dirs/com/example/notepad/databinding/**", "/jacocoDebug/dirs/com/example/notepad/databinding/**"))
                ?: mutableListOf("jacocoDebug/dirs/com/example/notepad/databinding/**", "/jacocoDebug/dirs/com/example/notepad/databinding/**")
...
//    androidTestImplementation("androidx.fragment:fragment-testing:1.6.2")
    ...
    testImplementation("org.roboelectric:roboelectric:4.11.1")
...
tasks.register<JacocoReport>("jacocoTestReport") {
    ...
    val fileFilter = listOf(
        ...
        "**/*MapperImpl*.*",
//        "**/*$ViewInjector*.*",
//        "**/*${android.databinding.tool.writer.ViewBinder}*.*",
        "**/BuildConfig.*",
        "**/*Component*.*",
        "**/*BR*.*",
        "**/Manifest*.*",
...
//        "**/*MapperImpl*",
//        "**/*TriggerClass",
        "/jacocoDebug/dirs/com/example/notepad/databinding/**",
    )

    val debugTree = fileTree(mapOf("dir" to "${project.buildDir}/intermediates/classes/debug", "excludes" to fileFilter))

    println("HELLOO:: ${debugTree.dir}")
    println("BYEE:: ${debugTree.excludes}")
...
tasks.register("cleanJacoco") {
    doLast {
        fileTree("build").matching { include("**/jacoco", "**/reports/jacoco") }.forEach { it.delete() }
    }
}
